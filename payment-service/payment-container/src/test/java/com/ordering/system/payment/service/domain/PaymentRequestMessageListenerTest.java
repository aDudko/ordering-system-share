...
import com.ordering.system.payment.service.dataaccess.outbox.entity.OrderOutboxEntity;
...
public class PaymentRequestMessageListenerTest {
    ...
    private PaymentRequest getPaymentRequest(String sagaId) {
        return PaymentRequest.builder()
                ...
                .paymentOrderStatus(com.ordering.system.domain.valueobject.PaymentOrderStatus.PENDING)
