package com.ordering.system.payment.service.domain.impl;
...
import com.ordering.system.payment.service.domain.event.PaymentCompletedEvent;
import com.ordering.system.payment.service.domain.event.PaymentCancelledEvent;
import com.ordering.system.payment.service.domain.event.PaymentEvent;
import com.ordering.system.payment.service.domain.event.PaymentFailedEvent;
import com.ordering.system.payment.service.domain.valueobject.CreditHistoryId;
...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    public PaymentEvent validateAndInitiatePayment(
        ...
        if (failureMessages.isEmpty()) {
            ...
            log.info("Payment initiation is failed for orderId: {}", payment.getOrderId().getValue());
    ...
    public PaymentEvent validateAndCancelPayment(
        ...
        if (failureMessages.isEmpty()) {
            log.info("Payment is cancelled for orderId: {}", payment.getOrderId().getValue());
