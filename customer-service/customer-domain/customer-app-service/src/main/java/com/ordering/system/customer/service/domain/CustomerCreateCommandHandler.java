...
import com.ordering.system.customer.service.domain.mapper.CustomerDataMapper;
...
public class CustomerCreateCommandHandler {
    ...
    public CustomerCreatedEvent createCustomer(CreateCustomerCommand createCustomerCommand) {
        ...
        log.info("Returning CustomerCreatedEvent for customerId: {}", createCustomerCommand.getCustomerId());
