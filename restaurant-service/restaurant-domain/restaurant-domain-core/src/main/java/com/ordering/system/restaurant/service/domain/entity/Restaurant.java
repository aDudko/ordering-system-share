package com.ordering.system.restaurant.service.domain.entity;
...
public class Restaurant extends AggregateRoot<RestaurantId> {
    ...
    public void validateOrder(List<String> failureMessages) {
        if (orderDetail.getOrderStatus() != OrderStatus.PAID) {
            failureMessages.add("Payment is not completed for orderId: " + orderDetail.getId());
        }
        ...
        if (!totalAmount.equals(orderDetail.getTotalAmount())) {
            failureMessages.add("Price total is not correct for orderId: " + orderDetail.getId());
        }
    }
