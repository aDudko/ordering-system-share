package com.ordering.system.restaurant.service.messaging.listener.kafka;
...
import com.ordering.system.restaurant.service.domain.exception.RestaurantApplicationServiceException;
...
public class RestaurantApprovalRequestKafkaListener implements KafkaConsumer<RestaurantApprovalRequestAvroModel> {
    ...
    public void receive(@Payload List<RestaurantApprovalRequestAvroModel> messages,
        ...
        messages.forEach(restaurantApprovalRequestAvroModel -> {
            try {
                log.info("Processing order approval for orderId: {}", restaurantApprovalRequestAvroModel.getOrderId());
                ...
                if (sqlException != null && sqlException.getSQLState() != null &&
                    ...
                    log.error("Caught unique constraint exception with sql state: {} " +
                                    "in RestaurantApprovalRequestKafkaListener for orderId: {}",
                ...
                // For RestaurantNotFoundException
                log.error("No restaurant found for restaurantId: {}, and orderId: {}",
